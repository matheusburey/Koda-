<template>
  <main id="content">
    ...
    <div class="bg-neutral-900">
      <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
        <h1 class="font-semibold text-white text-5xl md:text-6xl">
          <span class="text-primary">Koda X:</span> Transformando ideias em realidade
        </h1>
        <div class="max-w-4xl">
          <p class="mt-5 text-neutral-400 text-lg">
            É um centro criativo onde a imaginação encontra o artesanato para transformar ideias em realidades
            tangíveis.
            Na Koda X, nos especializamos em transformar visões conceituais em formas concretas, seja
            por meio de design, arte ou inovação tecnológica.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="relative overflow-hidden pt-4 bg-neutral-900">
      ...
      <div class="relative z-10">
        <div class="max-w-5xl px-4 xl:px-0 mx-auto">
          <div class="mb-4">
            <h2 class="text-neutral-400">Nossas tecnologias</h2>
          </div>
      ...
      <div class="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
        ...
        <div class="max-w-3xl mb-10 lg:mb-14">
          <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">
            Desenvolvimento de software aprimorado
          </h2>
          <p class="mt-1 text-neutral-400">
            Nossa joia real é nosso processo ÁGIL! Construído exclusivamente para o nosso modelo de parceria e geração
            de ideias para soluções reais.
          </p>
        </div>
        <!-- End Title -->
        ...
        <div
          ...
          <!-- Card -->
          <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-primary/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100"
            href="#">
            <div class="mb-5">
              <div class="mt-5">
                <div class="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="15" viewBox="0 0 28 21" fill="none">
                    <path
                      d="M27 15H26V3C26 2.20435 25.6839 1.44129 25.1213 0.87868C24.5587 0.316071 23.7956 0 23 0H5C4.20435 0 3.44129 0.316071 2.87868 0.87868C2.31607 1.44129 2 2.20435 2 3V15H1C0.734784 15 0.48043 15.1054 0.292893 15.2929C0.105357 15.4804 0 15.7348 0 16V18C0 18.7956 0.316071 19.5587 0.87868 20.1213C1.44129 20.6839 2.20435 21 3 21H25C25.7956 21 26.5587 20.6839 27.1213 20.1213C27.6839 19.5587 28 18.7956 28 18V16C28 15.7348 27.8946 15.4804 27.7071 15.2929C27.5196 15.1054 27.2652 15 27 15ZM4 3C4 2.73478 4.10536 2.48043 4.29289 2.29289C4.48043 2.10536 4.73478 2 5 2H23C23.2652 2 23.5196 2.10536 23.7071 2.29289C23.8946 2.48043 24 2.73478 24 3V15H4V3ZM26 18C26 18.2652 25.8946 18.5196 25.7071 18.7071C25.5196 18.8946 25.2652 19 25 19H3C2.73478 19 2.48043 18.8946 2.29289 18.7071C2.10536 18.5196 2 18.2652 2 18V17H26V18ZM17 5C17 5.26522 16.8946 5.51957 16.7071 5.70711C16.5196 5.89464 16.2652 6 16 6H12C11.7348 6 11.4804 5.89464 11.2929 5.70711C11.1054 5.51957 11 5.26522 11 5C11 4.73478 11.1054 4.48043 11.2929 4.29289C11.4804 4.10536 11.7348 4 12 4H16C16.2652 4 16.5196 4.10536 16.7071 4.29289C16.8946 4.48043 17 4.73478 17 5Z"
                      fill="#fff"></path>
                  </svg>
                ...
                <p class="font-semibold text-xl text-white mt-5">Engajamento e conversão em seu site</p>
                <p class="mt-1 text-neutral-400">
                  Tenha um site que seus clientes amam. Bonito, rápido, fácil de usar e bem indexado no Google.
                </p>
              </div>
            </div>
            <p class="mt-auto">
              <span
                class="font-medium text-sm text-primary pb-1 border-b-2 border-neutral-700 group-hover:border-primary transition focus:outline-none group-focus:border-primary">
                Saiba mais
              </span>
            </p>
          </a>
          ...
          <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-primary/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100"
            ...
            <div class="mb-5">
              <div class="mt-5">
                ...
                <p class="font-semibold text-xl text-white mt-5">Software do jeito que você sonhou</p>
                <p class="mt-1 text-neutral-400">
                  Desenvolvimento de sistemas sob medida, as ferramentas perfeitas para você transformar seu negócio.
                </p>
              </div>
            </div>
            <p class="mt-auto">
          ...
          <a class="group relative z-10 p-4 md:p-6 h-full flex flex-col bg-neutral-900 first:rounded-t-xl last:rounded-b-xl lg:first:rounded-l-xl lg:first:rounded-tr-none lg:last:rounded-r-xl lg:last:rounded-bl-none before:absolute before:inset-0 before:bg-gradient-to-b before:hover:from-transparent before:hover:via-transparent before:hover:to-primary/10 before:via-80% before:-z-[1] before:last:rounded-b-xl lg:before:first:rounded-s-xl lg:before:last:rounded-e-xl lg:before:last:rounded-bl-none before:opacity-0 before:hover:opacity-100"
            ...
            <div class="mb-5">
              <div class="mt-5">
                ...
                <p class="font-semibold text-xl text-white mt-5">A Equipe Perfeita</p>
                <p class="mt-1 text-neutral-400">
                  Monte seu time dos sonhos com desenvolvedores experientes e super talentosos.
                </p>
              </div>
            </div>
            <p class="mt-auto">
    ...
    <!-- Testimonials -->
    <div class="bg-neutral-900" id="reviews">
      <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
        <!-- Title -->
        <div class="max-w-3xl mb-10 lg:mb-14">
          <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">Avaliações Koda</h2>
          <p class="mt-1 text-neutral-400">
            Demonstramos orgulhosamente nossa dedicação inabalável à excelência e ao sucesso do cliente.
          </p>
        </div>
        <!-- End Title -->
          ...
          <div>
            ...
            <blockquote>
              <p class="font-medium text-xl text-white md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal">
                Dizer que a mudança para o
                <b class="text-primary">Koda X</b>
                mudou minha vida é um eufemismo. Meu negócio triplicou desde então.
              </p>
              ...
              <footer class="mt-6">
                <div class="flex items-center">
                  ...
                  <div class="ms-4 md:ms-0">
                    ...
                    <div class="text-xs text-neutral-400">Pagamentos e Riscos do Diretor</div>
                  </div>
                </div>
              </footer>
            </blockquote>
          ...
          <div class="p-4 lg:p-8 bg-gradient-to-bl from-neutral-800 via-neutral-900 to-neutral-950 rounded-xl">
            <div class="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
              ...
              <div
                ...
                <svg class="flex-shrink-0 size-6 sm:size-8 text-primary mx-auto" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="mt-3 sm:mt-5">
                  ...
                  <p class="mt-1 text-sm sm:text-base text-neutral-400">Parceiros</p>
                </div>
              </div>
              <!-- End Stats -->
              ...
              <div
                ...
                <div class="mt-3 sm:mt-5">
                  ...
                  <p class="mt-1 text-sm sm:text-base text-neutral-400">Clientes contentes</p>
                </div>
              </div>
              <!-- End Stats -->
              ...
              <div
                ...
                <div class="mt-3 sm:mt-5">
                  <h3 class="text-lg sm:text-3xl font-semibold text-white">$1M+</h3>
                  <p class="mt-1 text-sm sm:text-base text-neutral-400">Anúncios gerenciados anualmente</p>
                </div>
              </div>
              <!-- End Stats -->
            </div>
    ...
    <div class="bg-neutral-900" id="approach">
      ...
      <div class="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
        <!-- Title -->
        <div class="max-w-3xl mb-10 lg:mb-14">
          <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">Nossa abordagem</h2>
          <p class="mt-1 text-neutral-400">
            Essa visão profunda orienta nossa estratégia abrangente — desde pesquisa meticulosa e planejamento
            estratégico até a execução perfeita do desenvolvimento da marca e implantação de website ou produto.
          </p>
        </div>
        <!-- End Title -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 lg:items-center">
          ...
          <div>
            <!-- Heading -->
            <div class="mb-4">
              <h3 class="text-xs font-medium uppercase text-primary">
                Steps
              </h3>
            </div>
            <!-- End Heading -->
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div
                ...
                <div class="relative z-10 size-8 flex justify-center items-center">
                  <span
                    class="flex flex-shrink-0 justify-center items-center size-8 border border-neutral-800 text-primary font-semibold text-xs uppercase rounded-full">
                    1
                  </span>
                </div>
              </div>
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm lg:text-base text-neutral-400">
                  <span class="text-white">Pesquisa e Análise de Mercado:</span>
                  Identifique seu público-alvo e entenda suas necessidades, preferências e comportamentos.
                </p>
              </div>
              <!-- End Right Content -->
            </div>
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm lg:text-base text-neutral-400">
                  <span class="text-white">Desenvolvimento e testes de produtos:</span>
                  Desenvolva produtos ou serviços digitais que atendam às necessidades e preferências do seu
                  público-alvo.
                </p>
              </div>
              <!-- End Right Content -->
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm md:text-base text-neutral-400">
                  <span class="text-white">Marketing e Promoção:</span>
                  Desenvolva uma estratégia de marketing abrangente para promover seus produtos ou serviços digitais.
                </p>
              </div>
              <!-- End Right Content -->
            </div>
            ...
            <div class="flex gap-x-5 ms-1">
              ...
              <div class="grow pt-0.5 pb-8 sm:pb-12">
                <p class="text-sm md:text-base text-neutral-400">
                  <span class="text-white">Lançamento e Otimização:</span>
                  Lance seus produtos ou serviços digitais no mercado, monitorando de perto seu desempenho e usuário
                  opinião.
                </p>
              </div>
              <!-- End Right Content -->
    ...
    <div class="bg-neutral-900" id="contact">
      <div class="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
        <!-- Title -->
        <div class="max-w-3xl mb-10 lg:mb-14">
          <h2 class="text-white font-semibold text-2xl md:text-4xl md:leading-tight">Contate-nos</h2>
          <p class="mt-1 text-neutral-400">Seja qual for o seu objetivo - nós levaremos você até lá.</p>
        </div>
        <!-- End Title -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16">
              ...
              <div class="space-y-4">
                ...
                <div class="relative">
                  ...
                  <label for="hs-tac-input-name" class="absolute top-0 start-0 p-4 h-full text-neutral-400 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent
                    ...
                    peer-[:not(:placeholder-shown)]:text-neutral-400">Nome</label>
                </div>
                <!-- End Input -->
                ...
                <div class="relative">
                  ...
                  <label for="hs-tac-input-company" class="absolute top-0 start-0 p-4 h-full text-neutral-400 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent
                    ...
                    peer-[:not(:placeholder-shown)]:text-xs
                    peer-[:not(:placeholder-shown)]:-translate-y-1.5
                    peer-[:not(:placeholder-shown)]:text-neutral-400">Companhia</label>
                </div>
                <!-- End Input -->
                ...
                <div class="relative">
                  ...
                  <label for="hs-tac-input-phone" class="absolute top-0 start-0 p-4 h-full text-neutral-400 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent
                    ...
                    peer-[:not(:placeholder-shown)]:text-xs
                    peer-[:not(:placeholder-shown)]:-translate-y-1.5
                    peer-[:not(:placeholder-shown)]:text-neutral-400">Telefone</label>
                </div>
                <!-- End Input -->
                ...
                <div class="relative">
                  ...
                  <label for="hs-tac-message" class="absolute top-0 start-0 p-4 h-full text-neutral-400 text-sm truncate pointer-events-none transition ease-in-out duration-100 border border-transparent
                    ...
                    peer-[:not(:placeholder-shown)]:text-xs
                    peer-[:not(:placeholder-shown)]:-translate-y-1.5
                    peer-[:not(:placeholder-shown)]:text-neutral-400">Conte-nos sobre seu projeto</label>
                </div>
                <!-- End Textarea -->
              </div>
          ...
          <div class="space-y-14">
            ...
            <div class="flex gap-x-5">
              <svg class="flex-shrink-0 size-6 text-neutral-500" xmlns="http://www.w3.org/2000/svg" width="24"
              ...
              <div class="grow">
                ...
                <address class="mt-1 text-neutral-400 text-sm not-italic">
                  002 Rua Visconde de Nacar, Centro<br>
            ...
            <div class="flex gap-x-5">
              ...
              <div class="grow">
                ...
                <p class="mt-1 text-neutral-400">
                  Temos o prazer de anunciar que estamos expandindo nossa equipe e procurando
                  para pessoas talentosas como você se juntarem a nós.
                </p>
                <p class="mt-2">
                  <a class="group inline-flex items-center gap-x-2 font-medium text-sm text-primary decoration-2 hover:underline focus:outline-none focus:underline"
                    href="#">
                    Vagas de emprego
                    <svg
                      class="flex-shrink-0 size-4 transition group-hover:translate-x-0.5 group-hover:translate-x-0 group-focus:translate-x-0.5 group-focus:translate-x-0"
